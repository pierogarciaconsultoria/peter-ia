    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-background to-muted/30">
      ...
      <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => document.getElementById('beneficios')?.scrollIntoView({ behavior: 'smooth' })}>
              Benefícios
            </Button>
            <Button variant="ghost" onClick={() => document.getElementById('casos-sucesso')?.scrollIntoView({ behavior: 'smooth' })}>
              Cases
            </Button>
            <Button variant="ghost" onClick={() => document.getElementById('precos')?.scrollIntoView({ behavior: 'smooth' })}>
              Preços
            </Button>
      ...
      <section className="container py-20 md:py-32 flex flex-col items-center text-center space-y-8">
        <div className="space-y-6 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
            A primeira plataforma brasileira que integra <strong>IA, ISO 9001, RH e Planejamento Estratégico</strong> 
        ...
        <div className="container space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ProblemCard 
              ...
              description="Retrabalho, perda de prazos e clientes insatisfeitos consomem 40% do tempo da sua equipe."
              cost="R$ 8.000/mês"
            />
            <ProblemCard 
              title="Gestão de RH Manual"
              description="Planilhas desatualizadas, alta rotatividade e compliance em risco geram multas constantes."
              cost="R$ 12.000/mês"
            />
            <ProblemCard 
              title="Falta de Estratégia Clara"
              description="Decisões baseadas em 'achismo' levam a investimentos errados e oportunidades perdidas."
              cost="R$ 20.000/mês"
            />
          </div>
        </div>
      ...
      <section id="beneficios" className="container py-20 space-y-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard 
            ...
            title="Planejamento Estratégico IA"
            description="SWOT automático, BSC inteligente e OKRs que se ajustam conforme seus resultados."
            benefit="+85% precisão nas metas"
          />
          <FeatureCard 
            icon={<Award className="h-10 w-10 text-primary" />}
            title="ISO 9001 Automatizada"
            description="Certificação simplificada com IA que gera documentos, monitora processos e garante compliance."
            benefit="Certificação em 60 dias"
          />
          <FeatureCard 
            icon={<Users className="h-10 w-10 text-primary" />}
            title="RH Inteligente"
            description="Recrutamento com IA, análise DISC automática e gestão completa do ciclo de vida do colaborador."
            benefit="-70% turnover"
          />
          <FeatureCard 
            icon={<TrendingUp className="h-10 w-10 text-primary" />}
            title="Análises Preditivas"
            description="IA que antecipa problemas, sugere melhorias e otimiza processos automaticamente."
            benefit="+150% produtividade"
          />
        </div>
      ...
      <section id="casos-sucesso" className="bg-muted/50 py-20">
        <div className="container space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard 
              company="Metalúrgica Santos"
              result="+300% produtividade"
              quote="Em 3 meses conseguimos nossa ISO 9001 e reduzimos retrabalho em 80%. O ROI foi imediato."
              author="João Silva, CEO"
            />
            <TestimonialCard 
              company="Tech Solutions"
              result="-85% turnover"
              quote="O módulo de RH revolucionou nossa gestão de pessoas. Antes perdíamos 2 funcionários por mês."
              author="Maria Santos, RH"
            />
            <TestimonialCard 
              company="Construtora Alpha"
              result="+250% lucro"
              quote="O planejamento estratégico com IA nos ajudou a identificar oportunidades que não víamos."
              author="Carlos Mendes, Diretor"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <FAQItem 
              question="A Peter.IA substitui meu ERP atual?"
              answer="Não, a Peter.IA complementa seu ERP focando em gestão da qualidade, RH e planejamento estratégico com IA."
            />
            <FAQItem 
              question="Quanto tempo para ver resultados?"
              answer="Nossos clientes veem primeiros resultados em 7 dias e ROI completo em até 30 dias."
            />
            <FAQItem 
              question="Preciso de conhecimento técnico?"
              answer="Zero conhecimento técnico necessário. Interface intuitiva + suporte especializado incluso."
            />
            <FAQItem 
              question="Funciona para qual tamanho de empresa?"
              answer="Desde micro empresas até corporações. Nossa IA se adapta ao seu contexto e necessidades."
            />
          </div>
        </div>
      </section>
...
function ProblemCard({ title, description, cost }: { 
  title: string; 
  description: string; 
  cost: string;
}) {
...
function TestimonialCard({ company, result, quote, author }: { 
  company: string; 
  result: string; 
  quote: string; 
  author: string;
